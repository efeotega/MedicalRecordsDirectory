    ...
    <body style=" height:  100%; background-color: #f5f5f5; padding-bottom: 10px;">
        ...
        <div class="col-lg-offset-1 col-lg-10 box" style="vertical-align: middle; padding: 20px">
            <form action="addRecords.php" class="content-section" method="POST">
                ...
                <div class="row form-input-group">
                    <label style="float: left; vertical-align: middle;" class="col-lg-2">Date of Diagnosis</label><input
                        name="date" type="date" class="input-box col-lg-4">
                    <label style="" class="col-lg-2">Specialist Consulted</label><input name="dr" type="text"
                ...
                <p><small><i><i class="fas fa-exclamation-circle"></i> Please make sure all inputs are filled
                            correctly.</i></small></p>
                <button type="submit" name="submit" class="form-button-one"
                    style="background-color: #00cf7a; border-color:#00cf7a; color: white">Add Record</button>
            </form>
        </div>
    </body>
