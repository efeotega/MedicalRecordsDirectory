...
<body style=" height:  100%; background-color: #f5f5f5; padding-bottom: 10px;">
    ...
    <div class="col-lg-offset-4 col-lg-4 box" style="vertical-align: middle; padding: 20px">
        <form action="patientLogin.php" method="POST">
            <h1 style="font-size: 50px; font-family: bebas-neue ;">Patient Login</h1>
            <?php if (isset($error)) { ?>
                <br>
            ...
            <a href="patientRegister.php" class="form-button-one" style="border-color: #1e78ff; color: #1e78ff;">Register</a>
            <script>
