...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO pharmacists (`fname`,`lname`,`email`, `password`) 
    ...
    <div>
        <div>
            <div class="col-lg-offset-1 col-lg-10 box" style="vertical-align: middle; padding: 20px">
                <form action="addPharmacists.php" class="content-section" method="POST">
                    <h1 style="font-size: 50px; ">Add Pharmacists</h1>
