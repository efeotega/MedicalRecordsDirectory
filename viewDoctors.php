...
<body style=" height:  100%; background-color: #f5f5f5; padding: 10px;">
    ...
    if (isset($rows) && $rows >= 1) {
        ...
        echo "<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Specialty</th></tr>";
        ...
        while ($row = mysqli_fetch_assoc($results)) {
            ...
            echo "<td class='editable' data-column='email' contenteditable='false'>" . $row['specialty'] . "</td>";
    ...
    <script>
        function deleteRow(button) {
            if (confirm("Are you sure you want to delete this row?")) {
                ...
                xhr.open('POST', 'deleteDoctor.php', true);
