    ...
    <body style=" height:  100%; background-color: #f5f5f5; padding-bottom: 10px;">
        ...
        <div class="row">
            <div class="col-lg-offset-1 col-lg-5 box"
                style="vertical-align: middle; padding: 50px; font-family: Varela Round ">
                <h1 style="font-size: 50px; color: #1e78ff">View My Appointments</h1>
                <a href="viewMyAppointments.php" class="form-button-one" style="border-color: #1e78ff; color: #1e78ff"><i
                        class="fas fa-clipboard"></i> View My Appointments</a>
            </div>
            <div class="col-lg-5 box" style="vertical-align: middle; padding: 50px; font-family: Varela Round ">
                <h1 style="font-size: 50px;color: #00cf7a ">Book Appointment</h1>
                <a href="bookAppointments.php" class="form-button-one" style="border-color: #00cf7a; color: #00cf7a"><i
                        class="fas fa-file-medical"></i> Book Appointment</a>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-offset-1 col-lg-5 box" style="vertical-align: middle; padding: 50px; font-family: Varela Round ">
                ...
                <a href="patientMessagePage.php" class="form-button-one" style="border-color: #1e78ff; color: #1e78ff"><i
                        class="fas fa-clipboard"></i> Send A Message</a>
            </div>
            <div class="col-lg-5 box"
                style="vertical-align: middle; padding: 50px; font-family: Varela Round ">
                <h1 style="font-size: 50px; color: #ffbd00 ">Financial Records</h1>
                <a href="financeReports.php" class="form-button-one" style="border-color: #00cf7a; color: #00cf7a"><i
                        class="fas fa-file-medical"></i> View Finance Reports</a>
            </div>
        </div>
        <div class="row">
