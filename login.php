...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato|Montserrat|Open+Sans:300|Oswald|Raleway|Roboto"
        rel="stylesheet">
        ...
        <div style="padding-top: 5%; vertical-align: central;">
            ...
            <div class="content-section" style="font-family: bebas-neue">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="box">
                            <a style="color:  #1e78ff;" href="adminlogin.php">
                                <center>
                                    <i class="fas fa-hospital" style="font-size: 200px;"></i>
                                    <br><br>
                                    <span style="font-size: 50px">Admin</span>
                                </center>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="box">
                            <a style="color:  #1e78ff;" href="pharmacistlogin.php">
                                <center>
                                    <i class="fas fa-user" style="font-size: 200px;"></i>
                                    <br><br>
                                    <span style="font-size: 50px">Pharmacist</span>
                                </center>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="box">
                            <a style="color:  #1e78ff;" href="patientlogin.php">
                                <center>
                                    <i class="fas fa-user" style="font-size: 200px;"></i>
                                    <br><br>
                                    <span style="font-size: 50px">Patient</span>
                                </center>
                            </a>
                        </div>
                    </div>
            ...
            <br><br><br>
            <center style="font-family: Montserrat; font-size: 35px;color: black" class="col-12">New patient? <a
                    href="patientRegister.php" style="color: #1e78ff ">Register</a></center><br>
        </div>
    </div>
</body>
