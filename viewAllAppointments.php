...
<body style=" height:  100%; background-color: #f5f5f5; padding-bottom: 10px;">
    ...
    if (isset($rows) && $rows >= 1) {
        ...
        echo "<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Illness</th><th>Symptom</th><th>Allergies</th><th>Notes</th></tr>";
        ...
        while ($row = mysqli_fetch_assoc($results)) {
            ...
            echo "<td class='editable' data-column='allergies' contenteditable='false'>" . $row['allergies'] . "</td>";
