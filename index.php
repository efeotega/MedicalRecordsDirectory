...
<html>
    ...
    <body>
        ...
        <div style="height: 92vh;background-color: #1e78ff; color: white">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                            <div> 
                                ...
                                <div style="float: left;" class="row">
                                    ...
                                    <div style="border: solid 1px #1e78ff; border-radius: 10px; padding: 10px; font-family: Montserrat;"><a href="index.php" style="color: #1e78ff ;">See how it works</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="WhyRequireIt">
            <div style="height: 100vh; background-color: #e3f6ff; color: black;">
